...
--
-- Host: 127.0.0.1    Database: fax2emr
-- ------------------------------------------------------
...
CREATE TABLE `patient_information` (
  ...
  `Medical_Record_Number` varchar(1000) DEFAULT NULL,
  `Collection_Date` varchar(200) DEFAULT NULL,
  `Collection_Time` varchar(200) DEFAULT NULL,
...
-- Dump completed on 2014-11-08  1:42:11
